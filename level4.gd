...
var enemy_spawns = [Vector2(2,1),Vector2(2,1),Vector2(2,1),Vector2(2,1),Vector2(2,1),
				Vector2(2,3),Vector2(1,1),Vector2(1,1),Vector2(1,1),Vector2(1,1),
				Vector2(1,1),Vector2(2,1),Vector2(2,1),Vector2(2,3),Vector2(1,1),
				Vector2(1,1),Vector2(2,1),Vector2(2,1),Vector2(2,1),Vector2(1,1)]
